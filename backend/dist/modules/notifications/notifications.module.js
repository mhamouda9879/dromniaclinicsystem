...
exports.NotificationsModule = NotificationsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([notification_log_entity_1.NotificationLog]),
            appointments_module_1.AppointmentsModule,
            (0, common_1.forwardRef)(() => telegram_module_1.TelegramModule),
            patients_module_1.PatientsModule,
        ],
        controllers: [notifications_controller_1.NotificationsController],
        providers: [notifications_service_1.NotificationsService, notification_scheduler_1.NotificationScheduler],
