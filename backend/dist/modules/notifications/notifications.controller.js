...
let NotificationsController = class NotificationsController {
    ...
    sendQueueUpdate(appointmentId, body) {
        return this.notificationsService.sendQueueUpdate(appointmentId, body.queuePosition, body.estimatedWaitTime);
    }
    sendThankYou(appointmentId) {
...
__decorate([
    (0, common_1.Post)('booking-confirmation/:appointmentId'),
...
__decorate([
    (0, common_1.Post)('queue-update/:appointmentId'),
    __param(0, (0, common_1.Param)('appointmentId', common_1.ParseUUIDPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], NotificationsController.prototype, "sendQueueUpdate", null);
__decorate([
    (0, common_1.Post)('thank-you/:appointmentId'),
    __param(0, (0, common_1.Param)('appointmentId', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], NotificationsController.prototype, "sendThankYou", null);
__decorate([
