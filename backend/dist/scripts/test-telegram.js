...
async function testBotConnection() {
    ...
    try {
        const response = await axios_1.default.get(`${API_BASE}/getMe`, {
            timeout: 10000,
        });
...
async function testWebhookInfo() {
    ...
    try {
        const response = await axios_1.default.get(`${API_BASE}/getWebhookInfo`, {
            timeout: 10000,
        });
...
async function testSendMessage(chatId) {
    ...
    try {
        const response = await axios_1.default.post(`${API_BASE}/sendMessage`, {
            chat_id: chatId,
...
async function runAllTests(chatId) {
