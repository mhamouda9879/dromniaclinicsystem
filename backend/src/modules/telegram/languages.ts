/**
 * Language translations for Telegram bot
 */
...
export function translate(key: string, lang: Language, ...args: string[]): string {
  const translation = translations[lang]?.[key] || translations[Language.ENGLISH][key] || key;
